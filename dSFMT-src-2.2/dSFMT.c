 ...
 */
inline static void gen_rand_array_c1o2(dsfmt_t * restrict dsfmt, w128_t * restrict array,
				       int size) {
    int i, j;
    w128_t lung;
 ...
 */
void dsfmt_fill_array_close1_open2(dsfmt_t * restrict dsfmt, double array[], int size) {
    assert(size % 2 == 0);
